...
const patches = {
  ...
  'predefined-editorial': (html) => {
    ...
    h = addClassToStyle(
      ...
      'sec-pad block-pad-sm body-text',
    );
    h = h.replace(
    ...
    h = addClassToStyle(
      ...
      'sec-pad block-pad-footer',
    );
    h = h.replace(
      '<td align="right">',
      '<td align="right" class="footer-col">',
    );
  ...
  'predefined-aurora': (html) => {
    ...
    h = addClassToStyle(
      h,
      'padding:48px 40px 56px;color:#ffffff;',
      'aurora-hero-pad',
    );
    h = h.replace(
    ...
    h = h.replace(
      ...
      'class="sec-pad block-pad-sm" style="padding:24px 32px 0;"',
    );
    h = addClassToStyle(
      h,
  ...
  'predefined-ledger': (html) => {
    ...
    h = addClassToStyle(
      h,
      'background-color:#0c1729;padding:24px 36px;',
      'nav-pad',
    );
    h = h.replace(
    ...
    h = h.replace(
      /style="padding:28px 36px 0;"/g,
      'class="sec-pad block-pad-sm" style="padding:28px 36px 0;"',
    );
    h = addClassToStyle(h, 'padding:36px 36px 0;', 'sec-pad block-pad-lg');
    h = addClassToStyle(h, 'padding:32px 36px 28px;', 'sec-pad');
    h = addClassToStyle(
      h,
      'padding:0 36px 32px;background-color:#ffffff;',
      'sec-pad block-pad-footer',
    );
    h = h.replace(
  ...
  'predefined-itemized': (html) => {
    ...
    h = addClassToStyle(
      h,
      'padding:28px 32px 20px;background-color:#14532d;color:#ecfdf5;',
      'itemized-head-pad',
    );
    h = h.replace(
    ...
    h = h.replace(
      /style="padding:20px 32px 0;"/g,
      'class="sec-pad block-pad-sm" style="padding:20px 32px 0;"',
    );
    h = h.replace(
